    ...
    return (
        <div onChange={changeHandlers} className={s.deposit}>
            ...
            <div data-dashboard={showMin} className={s.deposit__info}>
                ...
                <p>Total profit: <span>{120 + rangeValue + '%'}</span></p>
                <p>In <i> {rangeValue} </i> days will
                    earn: <span>{(depositAmount * (100 + rangeValue) / 100).toFixed(2)} BUSD</span></p>
                <p>Daily ROI: <span>{(depositAmount * (100 + rangeValue) / 100 / rangeValue / 10).toFixed(2)} %</span>
                </p>
            </div>
